			...
			<div className="container px-6 py-12 mx-auto">
				...
				<div className="grid grid-cols-1 gap-8 mt-8 lg:mt-16 md:grid-cols-2">
					<div>
						...
						<div>
							<h1 className="text-xl font-semibold text-gray-700 dark:text-white">What is Simple CI?</h1>
					...
					<div>
						...
						<div>
							<h1 className="text-xl font-semibold text-gray-700 dark:text-white">How much does Simple CI cost?</h1>
					...
					<div>
						...
						<div>
							<h1 className="text-xl font-semibold text-gray-700 dark:text-white">What languages do you support?</h1>
					...
					<div>
						...
						<div>
							<h1 className="text-xl font-semibold text-gray-700 dark:text-white">What can I test?</h1>
